...
$id = $_SESSION['ids'] ; // Use the ID from AJAX request
            ...
            <form id="formArmas">   
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="serie" name="serie" placeholder="Ingrese el número de serie" required>
                    </div>
                    <div class="form-group">
                        <label for="reg_balistico" class="col-form-label">Registro Balístico:</label>
                        <input type="text" class="form-control" id="reg_balistico" name="reg_balistico" placeholder="Ingrese el registro balístico" required>
                    </div>
                    <div class="form-group">
                        <label for="tipo_arma" class="col-form-label">Tipo de Arma:</label>
                        <input type="text" class="form-control" id="tipo_arma" name="tipo_arma" placeholder="Ingrese el tipo de arma" required>
                    </div>
                </div>
...
<div class="modal fade" id="modalCRUDEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
