...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Carné de empleado DICSPS</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="SolicitudesEmpleados.php">Empleados DICSPS</a></li>
                <li class="breadcrumb-item active" aria-current="page">Permiso de Empleado DICSPS</li>
            </ol>
        </nav>
    </div>
 ...
 Dirección de Control de los Servicios Privados de Seguridad</p>
            ...
            <p class="wp" >El Director Genereal de Policía Nacional cerifica que el portador de este carné, identificado al anverso es miembro activo de la Policía Nacional,en tal sentido a las autoridades, prestarle la colaboracion necesaria en caso de solicitarla. </p>
