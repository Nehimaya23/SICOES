...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Detalle Vehiculos</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="SolicitudesBlindado.php">Solicitudes de Vehículos Blindados</a></li>
    ...
    <i class="fas fa-car"></i> Nuevo Vehículo Blindado
    </button>
